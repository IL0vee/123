...
namespace OnlineStore
{
    public partial class AdminForm : Form
    {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
             ...
             this.clientsTableAdapter.Update(this.onlineStoreDataSet1.Clients);
             this.productsTableAdapter.Update(this.onlineStoreDataSet.Products);
             this.ordersTableAdapter.Update(this.onlineStoreDataSet.Orders);
             this.usersTableAdapter.Update(this.onlineStoreDataSet.Users);
