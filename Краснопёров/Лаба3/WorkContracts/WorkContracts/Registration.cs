...
namespace WorkContracts
{
    public partial class Registration : Form
    {
        ...
        {
            string connection = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=WorkContracts.accdb";
        ...
        {
            string connStr = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=WorkContracts.accdb";
