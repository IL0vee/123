...
namespace StudentWork
{
    public partial class Registration : Form
    {
        ...
        {
            string connect = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=StudentWork.accdb";
        ...
        {
            string connStr = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=StudentWork.accdb";
